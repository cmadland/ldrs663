...
<span class="blockhead">Things To Do This Week</span>
...
- **Write** your arguments for or against the *Interaction Equivalency Theorem* in Obsidian.  
...
- [Critical inquiry in a text-based environment: Computer conferencing in higher education](https://www-sciencedirect-com.twu.idm.oclc.org/science/article/pii/S1096751600000166)  
...
- [Interaction and the online distance classroom: Do instructional methods effect the quality of interaction?](https://rdcu.be/cKSGf)


```{block2, type='blank'}
<span class="blockhead">✨ ProTip</span>
...
✅ I contact the [TWU library](https://libguides.twu.ca/help) for assistance, as librarians are among the most helpful people on the planet. In this case, I was provided an open link, but that link looks fishy as it isn't apparently tied to Kanuka's site, but rather an aggregation site. Often, I also request an inter-library loan, in which the TWU library would contact another library (maybe UVic) and request a copy through them.  
✅ Search [Google Scholar](https://scholar.google.com) as that will often pick up on preprints on the author's website.  
✅ Search [ResearchGate](https://www.researchgate.net/) for preprints.  
...
<span class="blockhead">An update on this link...</span>
...
![Community of Inquiry Model (Garrison, et al., (2000)](assets/u2/CoI-Model.jpg)
...
<span class="blockhead">Read, Annotate, and Reflect</span>


**Read** [Critical inquiry in a text-based environment: Computer conferencing in higher education](https://www-sciencedirect-com.twu.idm.oclc.org/science/article/pii/S1096751600000166) (access through the TWU library).
...
![Figure 1. Anderson's Modes of Interaction (2003)](assets/u2/Modes-Interaction-Anderson.png "Modes of Interaction from Terry Anderson")
...
![Figure 2. Kanuka's Model of Interaction (2011)](assets/u2/Kanuka-Modes-of-Interaction.png "Kanuka's Model of Interaction")
...
![Figure 3. Madland's Model of Interaction (2014)](assets/u2/Modes-of-Interaction-Madland.png "Madland's model of interaction")
...
```{block2, type='wp'}
<span class="blockhead">WordPress Post</span>


Please complete the assignment under 'Post 1' below. This will be your first of ~~five~~ four draft posts during the course.

[Blog Post 1](https://ma-lead.github.io/ldrs663/assessments.html#post-1)
...
```{block2, type='feedback'}
<span class="blockhead">Things To Do This Week - actually, 2 weeks!</span>
...
Your [**Small Group Facilitation Session**](https://far.twu.ca/ldrs/663-202109/assignments) is due <span class='badge-blue'>***DATE!!***</span>. Please begin scheduling your facilitation sessions with your groups this week so you have enough time to complete the sessions and your reflections.
...
![Zone of Proximal Development](assets/u3/ZPD_Image.png)
...
![Group Projects](assets/u3/U5_T2_Image.jpg)
...
![Cooperative Learning (Slavin, 2011)](assets/u3/Image3.png)
...
[Privacy, Ethics & Security in Digital Spaces Developing Awareness of Privacy](https://digitaltattoo.ubc.ca/quizzes/privacy-and-surveillance)  
...
[Please see the details for Post 4](https://ma-lead.github.io/ldrs663/assessments.html#post-4)

<!--chapter:end:06-u4.Rmd-->
...
In Unit 2 we were introduced to the idea that a learning environment can be understood as overlapping presences: *cognitive presence, social presence,* and *teaching presence.* In this unit, we explore what is experienced within this environment by examining the theoretical ground the CoI model is built upon.
...
## Topic 6 - Multi-Access Learning Environments {-}
...
![screenshot of the 'open another vault' button](assets/u1/obsidian2.png)
...
<iframe width="670" height="800" src="https://www.inoreader.com/stream/user/1006369874/tag/LDRS663%20Fall%202023/view/html?cs=m" frameborder="0" tabindex="-1"></iframe>
