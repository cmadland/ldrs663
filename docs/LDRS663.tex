...
\chapter*{WordPress Setup}\label{wordpress-setup}}
\addcontentsline{toc}{chapter}{WordPress Setup}
...
\hypertarget{wordpress-setup-1}{%
\section{WordPress Setup}\label{wordpress-setup-1}}
