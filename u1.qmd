...
1. Read Critical inquiry in a text-based environment: Computer conferencing in higher education.
2. Watch the video *You keep using that word* and consider what interaction is.
3. Read the article by Terry Anderson, *Getting the mix right again: An updated and theoretical rationale for interaction*.
...
- [Critical inquiry in a text-based environment: Computer conferencing in higher education](https://www-sciencedirect-com.twu.idm.oclc.org/science/article/pii/S1096751600000166){target="_blank"}  
- [Getting the mix right again: An updated and theoretical rationale for interaction](http://www.irrodl.org/index.php/irrodl/article/view/149/230){target="_blank"}   
- [Interaction and the online distance classroom: Do instructional methods effect the quality of interaction?](https://rdcu.be/cKSGf){target="_blank"}
...
// TODO #6 
::: {.callout-tip icon=false title="✨ ProTip"}
...
![Figure 1.1 Community of Inquiry Model (Garrison, et al., (2000)](assets/u2/CoI-Model.jpg){fig-alt="ommunity of Inquiry Model"}
...
![Figure 1.2 Anderson's Modes of Interaction (2003)](assets/u2/Modes-Interaction-Anderson.png "Modes of Interaction from Terry Anderson"){fig-alt="Modes of Interaction from Terry Anderson"}
...
![Figure 1.3 Kanuka's Model of Interaction (2011)](assets/u2/Kanuka-Modes-of-Interaction.png "Kanuka's Model of Interaction"){fig-alt="Kanuka's Model of Interaction"}
...
![Figure 1.4 Madland's Model of Interaction (2014)](assets/u2/Modes-of-Interaction-Madland.png "Madland's model of interaction"){fig-alt="Madland's model of interaction"}
