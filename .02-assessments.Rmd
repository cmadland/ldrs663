...
Throughout this course, you will be invited to write four “working” posts about what you are learning in this course.  Each of your draft posts should be 400-500 words. These posts will form a significant portion of the data that you use in your final assignments, so be sure to be detailed in your reflections and connect your reflections to the readings in the course and the course learning outcomes. You should consider your posts as a place for you to try out new ideas, to test your assumptions, and to share what you are learning with your community.
<!--
...
<!--
Working individually, find 8-10 peer-reviewed articles that have to do with facilitating learning in your area of employment or expertise. Import the metadata for each article into a collection in Zotero and attach the PDF of the article to the item. Use the Zotero Import tool in Obsidian to import each article into the ‘Notes’ folder in your vault, using the ‘source-note’ template provided. Use the ‘Annotate’ feature in Obsidian to highlight key points in the article, and complete the fields on the template. Make sure you connect the articles using wiki links. Use ‘tags’ in Obsidian to identify key themes in the articles.
-	Create a new file for each significant theme you identified in your notes
-	Export the collection as an RIS file and save it in your Obsidian vault.
