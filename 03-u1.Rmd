...
Once you have done all the reflections on these 5 steps, you can move forward with creating a blog. Please visit[create.twu.ca](https://create.twu.ca), click the blue 'Log in' link and follow the instructions. Once you are done there, you can return here to continue with the next section to get your site set up.
...
✔️  Meet in Zoom [Friday, March 25 - 7:30 AM PDT (Click to check your local time)](https://www.timeanddate.com/worldclock/fixedtime.html?msg=LDRS663+Meeting&iso=20220325T0730&p1=1109) AND [Friday, April 1 - 7:30 AM PDT (Click to check your local time)](https://www.timeanddate.com/worldclock/fixedtime.html?msg=LDRS663+Meeting&iso=20220401T0730&p1=1109&ah=1&am=30)   
✔️  **Create** a Visitor/Resident diagram to visualize your online presence.  
✔️  **Register** for a site at [create.twu.ca](https://create.twu.ca). I suggest you start with a 'General TWU site'.  
✔️  **Post** your site URL in the 'WordPress URLs' Glossary in Moodle.    
✔️  Please complete these items by ***Friday April 1***  

```
### Unit 1 Assessment

[Please see the details for Post 1](https://ma-lead.github.io/ldrs663/assessments)
